...
private val ZH_UI_TEXT = mapOf(
    ...
    "Schedules" to "定时计划",
    "Finished" to "已结束",
    "Mochi Agent" to "Mochi 智能体",
    "Shell task" to "Shell 任务",
    "Linked chat" to "关联聊天",
    "Schedule ended" to "计划已结束",
    "Back" to "返回",
    "Check setup" to "自检",
    "Activity" to "任务动态",
    "Syncing task status" to "正在同步任务状态",
    "Updates while open" to "打开时自动更新",
    "How it works" to "使用说明",
    "Some statuses could not be updated" to "部分状态暂时无法更新",
    "Earlier snapshots remain visible. Open details or check the connection." to "仍显示上次状态。可查看详情或检查连接。",
    "Ready when you are" to "随时可以开始",
    "Nothing in this view" to "这里暂时没有任务",
    "Tell Mochi what to do. Your tasks will appear here." to "告诉 Mochi 你想做什么，任务进展会汇聚到这里。",
    "Try another filter to see your other tasks." to "切换分类，看看其他任务。",
    "Ask Mochi" to "和 Mochi 说一声",
    "Find connection and setup issues" to "快速定位连接与配置问题",
    "Mochi is on it" to "Mochi 正在忙",
    "A little attention needed" to "有些任务需要关注",
    "Standing by" to "Mochi 待命中",
    "Your tasks are moving forward" to "任务正在推进，稍后回来看看",
    "One place for every task" to "任务与进展，一目了然",
    "Tap to see progress" to "轻点查看进展与操作",
    "Tap to view the result" to "轻点查看结果入口",
    "Tap to manage this schedule" to "轻点管理这项定时计划",
    "Tap for output and controls" to "轻点查看输出与控制",
    "Remote snapshot" to "远程状态快照",
    "Using tool" to "正在使用工具",
    "Close details" to "收起",
    "Stopping this run also cancels its active Subagent. Submitted Shell and remote tasks continue." to
        "停止本次执行也会取消正在运行的子 Agent。已提交的 Shell 和远程任务仍会继续。",
    "This Subagent belongs to a parent run. Stop affects both, not submitted Shell or remote tasks." to
        "此子 Agent 属于父任务，停止会同时取消两者，但不影响已提交的 Shell 或远程任务。",
    "Stops this run without changing the schedule switch." to "只停止本次执行，不改变定时计划的开关。",
    "Pause future runs" to "暂停后续计划",
    "Resume schedule" to "恢复定时计划",
    "Open planner" to "打开计划",
    "No output yet. Refresh to read the latest result." to "暂无输出，刷新可读取最新结果。",
    "No output was returned." to "命令未返回输出。",
    "Output" to "标准输出",
    "Error output" to "错误输出",
    "Output was truncated." to "输出过长，已截断。",
    "Refresh output" to "刷新输出",
    "Detached Shell processes may continue after Stop." to "已分离的 Shell 进程在停止后仍可能继续运行。",
    "Remove finished record" to "移除已结束记录",
    "Technical details" to "技术详情",
    "Task ID" to "任务 ID",
    "Exit code" to "退出码",
    "Open the linked chat for live progress, results and Stop. Mochi never automatically resubmits a remote task." to
        "打开关联聊天可查看实时进展、结果或停止任务。Mochi 不会自动重复提交远程任务。",
    "A clearer path to ready" to "让每项能力，都准备就绪",
    "Other checks" to "其他检查项",
    "Hide other checks" to "收起其他检查项",
    "Could not start this schedule. Check configuration and refresh before retrying." to "无法启动此定时计划，请检查配置并刷新后再试。",
    "Could not update the schedule. Check its date and refresh before retrying." to "无法更新定时计划，请核对日期并刷新后再试。",
    "Tasks" to "任务",
    "Task center" to "任务中心",
    "Configuration check" to "配置自检",
    "Run configuration check" to "开始配置自检",
    "Cancel check" to "取消检查",
    "Checking" to "正在检查",
    "Refreshing" to "正在刷新",
    "Check cancelled. Results below may be incomplete." to "检查已取消，以下结果可能不完整。",
    "Check sends one fixed short request to your saved AI Provider and may consume quota. No conversation, microphone audio or commands are sent. Settings are never changed." to
        "自检会向已保存的 AI Provider 发送一次固定短文本请求，可能消耗额度。不会发送对话、录音或执行命令，也不会修改设置。",
    "Last checked" to "上次检查",
    "Queued" to "排队中",
    "Running" to "执行中",
    "Failed" to "失败",
    "Cancelled" to "已取消",
    "Stop requested" to "已请求停止",
    "Not checked" to "尚未检查",
    "State unknown" to "状态未知",
    "Chat read succeeded; no tasks were returned." to "聊天读取成功，未返回任务记录。",
    "Scheduled" to "等待计划执行",
    "Not scheduled" to "未安排下次执行",
    "Last run cancelled" to "上次执行已取消",
    "Agent runs" to "Agent 执行记录",
    "No Agent runs in this app session." to "本次应用进程中暂无 Agent 执行记录。",
    "Agent runs update live during this app session. Scheduled work and Termux refresh while this page is visible. Remote chats refresh only on request. Closing this page does not stop tasks." to
        "本次应用进程中的 Agent 状态实时更新。页面可见时自动刷新定时任务与 Termux；远程聊天仅在主动刷新时读取。关闭此页不会停止任务。",
    "The run failed. Check configuration and review the conversation before retrying; earlier actions may already have completed." to
        "执行失败。请先检查配置并查看对话，再决定是否重试；之前的操作可能已经完成。",
    "Subagent" to "子 Agent",
    "Stop parent task" to "停止父任务",
    "Open conversation" to "查看对话",
    "Manage schedules" to "管理定时任务",
    "No scheduled tasks" to "暂无定时任务",
    "Next run" to "下次执行",
    "Last result" to "上次结果",
    "Stop current run" to "停止本次执行",
    "No known Termux tasks. Connect Termux and refresh to load retained tasks." to "暂无已知 Termux 任务。连接 Termux 后刷新可加载保留的任务。",
    "Refresh reads tasks from authorized linked chats when the provider and chat Tool are enabled. These are snapshots, not live progress. Open AgentLink for results and cancellation." to
        "启用 Provider 和聊天 Tool 后，刷新会读取已授权关联聊天中的任务。这是状态快照，并非实时进度；查看结果或取消任务请打开 AgentLink。",
    "No linked chats" to "暂无关联聊天",
    "Remote outcome unknown. Read the chat before resubmitting." to "远程操作结果未知，请先查看聊天，避免重复提交。",
    "Remote status not checked" to "尚未检查远程任务状态",
    "Open in AgentLink" to "在 AgentLink 中打开",
    "Stopping a parent cancels its Subagent, not already submitted Termux or remote tasks. Stop those in their own task controls. Detached Shell processes may survive Stop." to
        "停止父任务会取消其子 Agent，但不会停止已提交的 Termux 或远程任务；请分别使用对应的停止操作。分离的 Shell 进程仍可能继续运行。",
    "Passed" to "已通过",
    "Needs attention" to "需要处理",
    "Not tested" to "尚未实测",
    "Not enabled" to "未启用",
    "Open related settings" to "打开相关设置",
    "AI Provider" to "AI Provider",
    "Speech synthesis" to "语音合成",
    "Microphone permission" to "麦克风权限",
    "Skills and Tools" to "Skills 与 Tools",
    "Save the endpoint, model and API key in Settings." to "请在设置中保存服务地址、模型名称和 API 密钥。",
    "A fixed-text model request succeeded. Tool calling and image input were not tested." to "固定文本的模型请求成功。尚未测试工具调用与图像输入。",
    "Microphone permission is granted. No audio was recorded." to "已获得麦克风权限。本次检查没有录音。",
    "Allow microphone access in Android app permissions." to "请在 Android 应用权限中允许使用麦克风。",
    "Complete and save the selected speech provider credentials." to "请补全并保存所选语音服务的凭据。",
    "No Android recognition service is available. Install one or configure cloud speech." to "未发现可用的 Android 语音识别服务，请安装服务或配置云端语音。",
    "Configuration is available. Use the microphone to verify real recognition and cloud access." to "配置已就绪。请通过麦克风实际测试识别效果及云端服务权限。",
    "Android speech output is not ready. Check the installed engine and voice data." to "Android 语音输出尚未就绪，请检查语音引擎及已安装的语音数据。",
    "Use voice preview in Settings to verify the selected voice, playback and service quota." to "请在设置中试听音色，验证所选音色、播放及服务额度。",
    "Optional integration is not installed." to "尚未安装此可选集成。",
    "Open AgentLink and authorize Mochi in its native access page." to "请打开 AgentLink，在原生权限页面授权 Mochi。",
    "Open AgentLink and check the desktop Bridge connection." to "请打开 AgentLink，检查桌面 Bridge 连接。",
    "Connected but disabled. Enable only if you want Agents to use it." to "已连接但未启用。仅在需要 Agent 使用时开启。",
    "Connection is available. No remote task was started." to "连接可用。本次检查未启动任何远程任务。",
    "Skill is disabled; no changes are needed unless you want to use it." to "此 Skill 已禁用；若不使用，无需处理。",
    "Required Tools are available. External service calls were not tested." to "所需 Tools 已就绪。尚未实测外部服务调用。",
    "Connect and enable the missing groups and their required Tool switches." to "请连接并启用以下缺失分组及其所需的 Tool 开关。",
    "Install the extension from the same signing channel as Mochi. Do not uninstall to change channels." to "请安装与 Mochi 签名渠道一致的扩展。不要通过卸载来更换渠道。",
    "Open Configure Termux to check installation, Android command permission, external access and the Shell helper." to
        "打开“配置 Termux”，逐项检查安装状态、Android 命令权限、外部访问设置及 Shell 辅助脚本。",
    "Open extension setup and complete connection and device selection." to "请打开扩展设置，完成连接和设备选择。",
    "The extension reports connected. Device actions and Shell execution were not tested." to "扩展报告已连接。尚未实测设备操作或 Shell 执行。",
    "Check timed out. Verify the connection and try again." to "检查超时，请确认连接后重试。",
    "Check failed. Open the related settings, verify saved configuration and retry." to "检查失败，请打开相关设置核对已保存的配置后重试。",
    "Could not refresh schedules. Reopen the task center and try again." to "无法刷新定时任务，请重新打开任务中心后重试。",
    "Could not refresh AgentLink. Open Tools to check its connection." to "无法刷新 AgentLink，请在 Tools 中检查连接。",
    "Could not refresh Termux tasks. Check the connection in Tools." to "无法刷新 Termux 任务，请在 Tools 中检查连接。",
    "Termux task action failed. Refresh its state and check the connection." to "Termux 任务操作失败，请刷新状态并检查连接。",
    "Could not stop the scheduled run. Refresh its state before trying again." to "无法停止定时任务，请刷新状态后再试。",
    "Not now" to "暂不启用",
