...
private val ZH_UI_TEXT = mapOf(
    ...
    "Connect Baidu Map Agent Plan" to "连接百度地图 Agent Plan",
    "Open token page" to "打开令牌页面",
    "Service Key" to "服务密钥",
    ...
    "Copy your Baidu Map Agent Plan token" to "复制你的百度地图 Agent Plan 令牌",
    "Baidu Map Agent Plan connected" to "百度地图 Agent Plan 已连接",
    "Baidu Map Agent Plan disconnected" to "百度地图 Agent Plan 已断开",
    "MCP server removed" to "MCP 服务已移除",
    "Connected · 5 semantic map tools" to "已连接 · 5 个语义地图工具",
    "Open the official Tencent Docs page, copy your personal MCP token, then paste it below." to
        "打开腾讯文档官方页面，复制个人 MCP 令牌并粘贴到下方。",
    "Get a free-test Service Key from Baidu Maps, then paste it below. Mochi encrypts it on this device." to
        "从百度地图获取免费测试服务密钥并粘贴到下方。Mochi 会在此设备上加密保存。",
    ...
    "Baidu Place Search" to "百度地点搜索",
    "Semantically search places with Baidu Map Agent Plan." to "使用百度地图 Agent Plan 进行语义地点搜索。",
    "Baidu Route Planning" to "百度路线规划",
    "Plan driving, walking, cycling, or transit routes." to "规划驾车、步行、骑行或公交路线。",
    "Baidu Geocoding" to "百度地理编码",
    "Convert complete addresses to map coordinates." to "将完整地址转换为地图坐标。",
    "Baidu Reverse Geocoding" to "百度逆地理编码",
    "Convert trusted coordinates to addresses." to "将可信坐标转换为地址。",
    "Baidu Map Weather" to "百度地图天气",
    "Read weather by region or trusted coordinates." to "按区域或可信坐标读取天气。",
